...
$vbsContent += "' ================================================================" + "`r`n"
$vbsContent += "" + "`r`n"
$vbsContent += 'Dim objShell, sPS, sCmd' + "`r`n"
$vbsContent += 'Set objShell = CreateObject("Shell.Application")' + "`r`n"
$vbsContent += "" + "`r`n"
...
$vbsContent += "" + "`r`n"
$vbsContent += 'sCmd = "-NoProfile -NonInteractive -WindowStyle Hidden -ExecutionPolicy Bypass -Command """ & sPS & """"' + "`r`n"
$vbsContent += 'objShell.ShellExecute "powershell.exe", sCmd, "", "open", 0' + "`r`n"
$vbsContent += "" + "`r`n"
$vbsContent += 'Set objShell = Nothing' + "`r`n"
